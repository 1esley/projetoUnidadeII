...
while True: # while menu principal
    ...
    if opcaoMenuPrincipal == '1':
                ...
                if opcaoMenuCliente == '1':
                    ...
                    while True:
                        ...
                        if confirmarCompra == '0':
                            ...
                            print('\n\nGERANDO NOTA FISCAL...')
                            print('#' * 50 + '\n' + '-' * 15 + '\nNOTA FISCAL\n' + '-' * 15 + '\n' + f'Valor total: R$ {precoTotalPrint:.2f}\n' + f'Forma de pagamento: {pagouNo}\n' + f'Desconto: {desconto}\n' + f'Acréscmo: {acrescimo}\n' + f'Valor a ser pago: R$ {valorPagamento:.2f}\n' + '-' * 50 + '\nOBRIGADO PELA COMPRA, E TENHA UM BOM FILME!\n' + '-' * 50 + '\n' + '#' * 50)
                            break
        ...
        while True: #while menu de cadastro
            ...
            if ('@' in email) and ('.com' in email): # 459 - 468 | verificar se o email é válido
                #coisas que quebram: @.com | user@gmail.comm | user@1g1m1a1i1l1.1c1o1m1
        ...
        while True: # while confirmar senha
            senhaUm = input('Insira sua senha: ').lower()
            senhaConfirmacao = input('Insira sua senha novamente para confirmar: ').lower()
